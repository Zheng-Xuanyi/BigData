 ...
 */
public class TransformRollingAggTest {
...
//        KeyedStream<SensorReading, Tuple> sensorKeyBy = sensorDs.keyBy("id");

        KeyedStream<SensorReading, String> sensorKeyBy = sensorDs.keyBy(new KeySelector<SensorReading, String>() {
            @Override
        ...
        SingleOutputStreamOperator<SensorReading> temperature = sensorKeyBy.max("temperature");

        temperature.print("min");
